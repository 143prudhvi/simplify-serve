...
import com.simplify.myapp.domain.Contact;
import com.simplify.myapp.service.ContactService;
...
/**
 * REST controller for managing {@link com.simplify.myapp.domain.Contact}.
 */
@RestController
@RequestMapping("/api")
